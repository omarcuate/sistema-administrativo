...
$sql="update recaudacion set fechas='".$marca."',
recaudacion_millones_pesos='".$modelo."' where id='".$ID."'";
...
if($result){
    ...
    $marca=$filas["fechas"];
    $modelo=$filas["recaudacion_millones_pesos"];
...
<div class="content-box">
  ...
  <div class="cont-edit">
    <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
       ...
       <label ><ion-icon name="cash-outline"></ion-icon>Recaudacion en millones de pesos:</label>
       <br>
 ...
 <button class="actualizar"type="submit" name="enviar">Actualizar</button>
    ...
    <?php
                   ...
                   <script>                         
                            ...
                            // Crear las gráficas
                            var ctxRecaudacion = document.getElementById('graficaRecaudacion').getContext('2d');
                            var graficaRecaudacion = new Chart(ctxRecaudacion, {
                                type: 'bar',
